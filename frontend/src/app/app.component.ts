...
@Component({
  ...
  imports: [
    ...
    MatToolbarModule, MatButtonModule, MatIconModule, MatBadgeModule, MatTooltipModule, MatMenuModule, MatDividerModule,
  ],
...
export class AppComponent {
  ...
  readonly isAdmin = computed(() => this.authService.isAuthenticated());
